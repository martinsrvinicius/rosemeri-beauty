<template>
  <va-dropdown class="notification-dropdown" position="bottom" :offset="[13, -150]">
    <template #anchor>
  ...
  const props = withDefaults(
    ...
    }>(),
    {
      notifications: () => [
        {
          name: 'sentMessage',
          details: { name: 'Vinicius M', avatar: 'https://picsum.photos/123' },
          unread: true,
          id: 1,
        },
        {
