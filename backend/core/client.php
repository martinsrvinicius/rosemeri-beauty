...
class Client
{
    ...
    {
        //create query
        $query = 'SELECT uniqueId, nome, data_nasc, telefone, whatsapp, nif, rua, localidade, zipcode, pais, email from `cliente`';
    ...
    data_nasc=:data_nasc, telefone=:telefone, whatsapp=:whatsapp, rua=:rua, localidade=:localidade, zipcode=:zipcode, pais=:pais, email=:email WHERE uniqueId=:uniqueId';
    ...
    {
        $query = "DELETE FROM `cliente` WHERE uniqueId=?";
